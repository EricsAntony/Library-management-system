...
if(isset($_SESSION["sess_user"])){
 include_once 'db.php';
 $result1 = mysqli_query($conn,"select * from student where view=1 order by `adm`");
  ?>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table id="Students" width="100%" cellspacing="0" cellpadding="15">
                  <thead>
                    <tr>
...
?> <td> <?php echo $row["adm"]; ?>  </td>   
 ...
 <td> <?php echo $row["batch"]; ?>  </td> 
  ...
  <td> <a href="restore.php?adm=<?php echo $row["adm"]; ?>" id="res"><i class="fas fa-trash-restore" title="Undo"></i></td></a>
  </tr>  
<?php
}
?>
