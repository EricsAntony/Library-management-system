...
if(isset($_SESSION["sess_user"])){
 ...
 <?php
 include_once 'db.php';
 $result1 = mysqli_query($conn,"SELECT * FROM teacher where view=0 order by `t_date` desc");
 ?>
 <html lang="en">
 <head>
          ...
          <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
              <div class="input-group">
                <input type="text" class="form-control bg-light border-0 small" placeholder="Search by name..." aria-label="Search" aria-describedby="basic-addon2" id="Input" onkeyup="myFunction()">
              ...
              <li class="nav-item dropdown no-arrow d-sm-none">
                ...
                <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                  <form class="form-inline mr-auto w-100 navbar-search">
                    <div class="input-group">
                      <input type="text" class="form-control bg-light border-0 small" placeholder="Search by name..." aria-label="Search" aria-describedby="basic-addon2" id="InputP" onkeyup ="myFunctionPhone()">
                      <div class="input-group-append">
                        <button class="btn btn-primary" type="button">
                          <i class="fas fa-search fa-sm"></i>
                        </button>
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                ...
                <a href="regTeacher.php" class="btn btn-primary" style="float: right;">Add </a>
              </div>
              <div class="card-body">
                    ...
                    <thead>
                      ...
                      <tr>
                       ...
                       while($row = mysqli_fetch_array($result1)) 
                       {
                        ...
                        <td><a href="editTeacher.php?t_id=<?php echo $row["t_id"]; ?>"><i class="fas fa-edit" title="edit"></i></a>&nbsp&nbsp&nbsp<a href="delTeacher.php?t_id=<?php echo $row["t_id"]; ?>"><i class="fas fa-trash" title="Delete"></i></a>&nbsp&nbsp&nbsp
