...
if(isset($_SESSION["sess_user"])){
 ...
 $result1 = mysqli_query($conn,"SELECT `issue`.`name`, `issue`.`title`, `issue`.`date`, `issue`.`ubin`, `issue`.`adm`, `issue`.`status`, `issue`.`batch`, `issue`.`issue_by` FROM issue,student where `student`.`view`= 0  and `student`.`adm` = `issue`.`adm` and `issue`.`date` between '$fdate' and '$ldate'");
 ?>
 <html lang="en">
 <head>
          ...
          <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
              <div class="input-group">
                <input type="text" class="form-control bg-light border-0 small" placeholder="Search by UBIN, Adm Number, Name, Title or Status..." aria-label="Search" aria-describedby="basic-addon2" id="Input" onkeyup="myFunction() " onkeydown="return (event.keyCode!= 13);">
            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
                ...
                <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                  <form class="form-inline mr-auto w-100 navbar-search">
                    <div class="input-group">
                      <input type="text" class="form-control bg-light border-0 small" placeholder="Search by UBIN, Adm Number, Name, Title or Status..." aria-label="Search" aria-describedby="basic-addon2" id="InputP" onkeyup="myFunctionPhone() " onkeydown="return (event.keyCode!= 13);">
                      <div class="input-group-append">
                        <button class="btn btn-primary" type="button">
                          <i class="fas fa-search fa-sm"></i>
                        </button>
                  ...
                  for (j = 0; j < filter.length; j++) {
                    ...
                    for (i = 0; i < tr.length; i++) {
                      ...
                      if (src!='' && td && td2 && td3  && td5 && td6) {
                        ...
                        if (txtValue.toUpperCase().indexOf(src) > -1 || txtValue2.toUpperCase().indexOf(src) > -1 || txtValue3.toUpperCase().indexOf(src) > -1 || txtValue5.toUpperCase().indexOf(src) > -1 || txtValue6.toUpperCase().indexOf(src) > -1) {
                          tr[i].style.display = "";
                        } else {
