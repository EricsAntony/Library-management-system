...
<script >
	$('input#ubin').on('focusout', function(){
		...
		if ($.trim(ubin) != ''){
			$.post('loadIssue.php', {ubin: ubin}, function(data){
	...
	function checkInp()
	{
		...
		if (isNaN(x)) 
		{
			...
			$('input#admi').on('focusout', function(){
				...
				if ($.trim(admi) != ''){
					$.post('loadIssueCheck.php', {admi: admi}, function(data){
			...
			$('input#admi').on('focusout', function(){
				var admi = $('input#admi').val();
				if ($.trim(admi) != ''){
					$.post('loadIssueAdm.php', {admi: admi}, function(data){
			...
			$('input#admi').on('focusout', function(){
				var admi = $('input#admi').val();
				if ($.trim(admi) != ''){
					$.post('loadIssueBatch.php', {admi: admi}, function(data){
