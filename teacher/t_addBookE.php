...
<body>
   ...
   <a href="t_home.php"  style="text-decoration: none;
    ...
    <h5 class="help-block">**Upload data in the following order(ubin,title,author,publisher,category,price,donated by,batch of donation,donated on(yyyy-mm-dd)) without column headings</h5><br><br>
...
if(isset($_POST["submit"]))
{
 ...
 else
 {
      ...
      window.location = "t_addBookE.php";
        });
      </script>
      <?php
 }
