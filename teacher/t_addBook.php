...
if(isset($_SESSION["sess_user1"])){
	...
	<body>
		<form action="" method="post" name="myForm" onsubmit="return checkInp()">
			...
			<div class="input-data">
				<input type="date" required name="don_on" >
				<div class="underline"></div>
...
if(isset($_POST["save"]))
{
	...
	# code...
		$sql = "INSERT INTO book(ubin,title,author,publisher,category,price,date,don_by,don_batch)values('$ubin','$title','$author','$publisher','$category','$price',NOW(),'$don_by','$don_batch')";
