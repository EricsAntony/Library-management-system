        ...
        <div id="content">
          ...
          <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
            ...
            <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
              <div class="input-group">
                <input type="text" class="form-control bg-light border-0 small" placeholder="Search by UBIN, Adm Number, Name, title..." aria-label="Search" aria-describedby="basic-addon2" id="Input" onkeyup="myFunction()" onkeydown="return (event.keyCode!= 13);">
          ...
          <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
              ...
              <form method="post" action="t_viewIssued1.php">
                ...
                <a href="t_viewIssued.php" class="btn">Show all</a>
               </div>
             </form>
              ...
              <table id="Students" width="100%" cellspacing="0" cellpadding="14" >
                <thead>
                  ...
                  <tr>
                    ...
                    <td>          <?php include't_filter1.php'?></td>
