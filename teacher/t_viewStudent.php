...
<td><a href="t_editStudent.php?adm=<?php echo $row["adm"]; ?>"><i class="fas fa-edit" title="edit"></i></a>&nbsp&nbsp&nbsp
 <a href="t_delProcess.php?adm=<?php echo $row["adm"]; ?>" name="delete"> <i class="fas fa-trash" title="Delete"></i></a></td>  
  </tr>  
<?php
}
?>
