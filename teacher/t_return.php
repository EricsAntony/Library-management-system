...
<script >
	$('input#ubin').on('focusout', function(){
		...
		if ($.trim(ubin) != ''){
			$.post('t_loadReturn.php', {ubin: ubin}, function(data){
				$('#ubin-data').val(data);
...
<script >
	$('input#ubin').on('focusout', function(){
		var ubin = $('input#ubin').val();
		if ($.trim(ubin) != ''){
			$.post('t_loadReturnName.php', {ubin: ubin}, function(data){
				$('#name-data').val(data);
...
<script >
	$('input#ubin').on('focusout', function(){
		var ubin = $('input#ubin').val();
		if ($.trim(ubin) != ''){
			$.post('t_loadReturnAdm.php', {ubin: ubin}, function(data){
				$('#adm-data').val(data);
...
<script >
	$('input#ubin').on('focusout', function(){
		var ubin = $('input#ubin').val();
		if ($.trim(ubin) != ''){
			$.post('t_loadReturnDate.php', {ubin: ubin}, function(data){
				$('#date-data').val(data);
...
<script >
	$('input#ubin').on('focusout', function(){
		var ubin = $('input#ubin').val();
		if ($.trim(ubin) != ''){
			$.post('t_fetchDate.php', {ubin: ubin}, function(data){
				$('#day').text(data);
