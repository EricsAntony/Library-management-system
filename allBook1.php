...
if(isset($_SESSION["sess_user"])){
 ...
 $ubin = $_REQUEST['ubin'];
 $result2 = mysqli_query($conn,"SELECT * FROM book where view=0 and ubin = '$ubin'");
        ...
        <div id="content">
          ...
          <div class="container-fluid">
                    ...
                    <thead>
                      ...
                      <tr>
                       ...
                       while($row = mysqli_fetch_array($result1)) 
                       {
                        ...
                        <td> <a href="viewBookDetails.php?ubin=<?php echo $row["ubin"]; ?>"> <i class="far fa-eye" title="View book details"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="editBook.php?ubin=<?php echo $row["ubin"]; ?>"><i class="fas fa-edit" title="edit"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                         <a href="bookDelPro.php?ubin=<?php echo $row["ubin"]; ?>"> <i class="fas fa-trash" title="Delete"></i></a>
                       </td>  
                     </tr>  
                     <?php
                   }
            ...
            <script type="text/javascript">
              swal({
                title: "<?php echo $row1['title'];?> ",
                text: "Author: <?php echo $row1['author'];?> \n Publisher: <?php echo $row1['publisher'];?> \n Category: <?php echo $row1['category'];?> \n Donated by: <?php echo $row1['don_by'];?> \n Batch of donation: <?php echo $row1['don_batch'];?> \n Donated on: <?php echo $row1['don_on'];?>\n Price: <?php echo $row1['price'];?> \n Status: <?php echo $row1['status'];?>",
              }).then(function() {
