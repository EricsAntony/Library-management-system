              ...
              <li class="nav-item dropdown no-arrow d-sm-none">
                ...
                <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in" aria-labelledby="searchDropdown">
                  <form class="form-inline mr-auto w-100 navbar-search">
                    <div class="input-group">
                      <input type="text" class="form-control bg-light border-0 small" placeholder="Search by UBIN, Title, Status" aria-label="Search" aria-describedby="basic-addon2" id="InputP" onkeyup ="myFunctionPhone()">
                      <div class="input-group-append">
                        <button class="btn btn-primary" type="button">
                          <i class="fas fa-search fa-sm"></i>
                        </button>
                    ...
                    <thead>
                      ...
                      <tr>
                       ...
                       while($row = mysqli_fetch_array($result1)) 
                       {
                        ...
                        <td> <a href="allBook1.php?ubin=<?php echo $row["ubin"]; ?>"> <i class="far fa-eye" title="View book details"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="editBook.php?ubin=<?php echo $row["ubin"]; ?>"><i class="fas fa-edit" title="edit"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
